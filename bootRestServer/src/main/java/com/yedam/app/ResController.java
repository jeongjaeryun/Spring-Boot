...
public class ResController {
	...
	@ResponseBody
	@GetMapping("resStr")
	public String resStr() throws InterruptedException { //String은 json 아님
		Thread.sleep(2000);
		return "str hello!";
	}
	...
	public ResponseEntity<GreetingVO> resEntity() {
		...
		//														(바디, 상태) 바디에 담긴걸 json형태로 보내줌		
		ResponseEntity<GreetingVO> entity = new ResponseEntity<>(vo, HttpStatus.BAD_REQUEST); //OK는 200
		return entity;
	}
